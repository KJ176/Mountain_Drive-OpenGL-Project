...
const int font1=(intptr_t)GLUT_BITMAP_TIMES_ROMAN_24;
const int font2=(intptr_t)GLUT_BITMAP_HELVETICA_18 ;
const int font3=(intptr_t)GLUT_BITMAP_8_BY_13;
...
int main(int argc, char** argv)
{
    ...
    printf("Dynamic Landscape\n");
    printf("\nKeyboard Interaction:\n \n");
    printf("For Truck:\n");
    printf("Press a : To Slow down the Truck\n");
    printf("Press s: to make the truck drive faster\n");
   printf ("\nFor Car:\n");
   printf ("Press  d: To Slow down the car\n");
  printf ("Press  f: to make the car drive faster\n");
